...
async function run() {
    try {
        ...
        app.get('/crafts/:id', async (req, res) => {
            ...
            const result = await craftCollection.findOne(filter);
            res.send(result)
        })
